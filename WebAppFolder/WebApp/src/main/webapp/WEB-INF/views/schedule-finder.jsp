...
<body>
	...
	<h3>Search For Open Dates To Hold Events</h3>
	<br>
	<form action="/schedule-finder1" method="get">
		Date Start: <input type="date" name="start" required /><br> Date
		End: <input type="date" name="end" required /><br> List of
		Employees: <input type="text" name="employees"
			placeholder="Add multiple employees by separating with a comma" /> <br>
		<input type="submit" />
